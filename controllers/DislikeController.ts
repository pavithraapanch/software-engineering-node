 ...
 *     </li>
 *     <li>DELETE /api/users/:uid/removeDislikes/:tid to record that a user
 *     removes dislike from an already disliked tuit</li>
 * </ul>
...
export default class DislikeController implements DislikeControllerI {
    ...
    findAllTuitsDislikedByUser = (req: Request, res: Response) => {
        ...
        DislikeController.dislikeDao.findAllTuitsDislikedByUser(userId)
            .then(dislikes => {
                ...
                const tuitsFromDislike = dislikesNonNullTuits.map(dislike => dislike.tuit);
    ...
    userTogglesTuitDislikes = async (req: Request, res: Response) => {
        ...
        try {
            ...
            await tuitDao.updateLikesAndDislikes(tid, tuit.stats);
            res.sendStatus(200);
        } catch (e) {
            res.sendStatus(404);
        }
